...
export { default as signupImg } from './assets/signup.png';
export { default as aboutVid } from './assets/about-video.mp4';
export { default as showcaseImg } from './assets/dashboard.png';
