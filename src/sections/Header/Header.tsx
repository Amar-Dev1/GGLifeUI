            ...
            <div id='header' className='w-[95%] lg:w-[90%] container bg-gray-50 backdrop:blur-sm flex justify-between items-center p-3 mx-auto rounded-full'>
                ...
                <div className='wide-nav hidden lg:flex xl:flex'>
                    ...
                    <div className='about-link px-4 py-2 mx-1 text-black cursor-pointer relative group'>
                        about
                        <img src={arrowDown} alt="" className='w-2.5 absolute right-0 top-1/2 -translate-y-1/2 group-hover:rotate-180 transition-all' />
                        <div className='about-links w-60 h-auto bg-[rgba(230,230,230,.7)] rounded-2xl flex flex-col p-5 shadow absolute left-1/2 top-10 -translate-x-1/2 z-[99] pointer-events-none scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-300'>
                            <a href="#showcase" className='block text-black my-1 hover:translate-x-4 transition-transform duration-300'>Why GGLife ?</a><hr className='opacity-25'/>
                            <a href="#about" className='block text-black my-1 hover:translate-x-4 transition-transform duration-300'>About GGLife</a>
                        </div>
                    </div>
